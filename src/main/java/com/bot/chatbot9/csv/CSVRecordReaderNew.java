...
public class CSVRecordReaderNew extends LineRecordReaderNew {
    ...
    private SerializableCSVParserNew csvParser;

    /**
     * Skip first n lines
     * @param skipNumLines the number of lines to skip
     */
    public CSVRecordReaderNew(int skipNumLines) {
     ...
     */
    public CSVRecordReaderNew(char delimiter){
        this(0, delimiter);
    }
     ...
     */
    public CSVRecordReaderNew(int skipNumLines, char delimiter) {
     ...
     */
    @Deprecated
    public CSVRecordReaderNew(int skipNumLines, String delimiter){
     ...
     */
    public CSVRecordReaderNew(int skipNumLines, char delimiter, char quote) {
        this.skipNumLines = skipNumLines;
        this.csvParser = new SerializableCSVParserNew(delimiter, quote);
    }
     ...
     */
    @Deprecated
    public CSVRecordReaderNew(int skipNumLines, String delimiter, String quote) {
        this(skipNumLines, stringDelimToChar(delimiter), stringDelimToChar(quote));
    }

    public CSVRecordReaderNew() {
    ...
    public void initialize(Configuration conf, InputSplit split) throws IOException, InterruptedException {
        ...
        this.csvParser = new SerializableCSVParserNew(conf.getChar(DELIMITER, DEFAULT_DELIMITER), conf.getChar(QUOTE, DEFAULT_QUOTE));
    }
    ...
    public Record nextRecord() {
        ...
        RecordMetaData meta = new RecordMetaDataLine(this.lineIndex - 1, uri, CSVRecordReaderNew.class); //-1 as line number has been incremented already...
