...
public class LineRecordReaderNew extends BaseRecordReaderNew {
	/**
	 * 
	 */
    ...
    public boolean resetSupported() {
        if(inputSplit != null){
            return ((RecordReaderNew) inputSplit).resetSupported();
        }
        return true;
    }
    ...
    public Record nextRecord() {
        ...
        RecordMetaData meta = new RecordMetaDataLine(this.lineIndex - 1, uri, LineRecordReaderNew.class); //-1 as line number has been incremented already...
