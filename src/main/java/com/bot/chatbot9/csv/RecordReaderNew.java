...
public interface RecordReaderNew extends Closeable, Serializable, Configurable {
	
	String NAME_SPACE = RecordReaderNew.class.getName();
     ...
     */
    List<RecordListenerNew> getListeners();

    /**
     * Set the record listeners for this record reader.
     */
    void setListeners(RecordListenerNew... listeners);

    /**
     * Set the record listeners for this record reader.
     */
    void setListeners(Collection<RecordListenerNew> listeners);
